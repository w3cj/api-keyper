<template>
  <!-- <div class="create"> -->
    <div style="flex: 1;">
      ...
      <div class="container">
        <div class="row" v-if="!creating">
          <h3 class="header center">Create a Keyper Client</h3>
          <form class="col s12">
            <div class="row">
              <div class="col s12">
                <h4>Name</h4>
                <p>
                  Give a descriptive name of the app that will be using this API.
                </p>
              </div>
              <div class="input-field col s12">
                <input v-model="name" placeholder="My Awesome App 2.0" id="name" type="text" class="validate" required>
            ...
            <div class="row">
              ...
              <div class="input-field col s12">
                <input v-model="host" placeholder="maps.googleapis.com" id="host" type="text" class="validate" required>
            ...
            <div class="row">
              ...
              <div class="col s3">
                <a v-bind:disabled="!isValidClient()" v-on:click="create" class="waves-effect waves-light btn-large text-center green">Create</a>
              </div>
            </div>
          </form>
        </div>
  ...
  methods: {
    ...
    isValidClient() {
      return this.name && this.host &&
              ...
              (this.queries.length > 0 || this.headers.length > 0);
    },
    create() {
      ...
      API
        ...
        .then((json) => {
          ...
          this.$router.push({ name: 'client', params: { id: json.client_id }})
        }).catch((error) => {
          console.log(error);
        });
    },
